...
TrackFaceLapBase::TrackFaceLapBase()
{
    ...
    Unicode::snprintf(timerValueBuffer, TIMERVALUE_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_Q3KS).getText());
    ...
    distanceUnits.setPosition(174, 129, 45, 19);
    ...
    Unicode::snprintf(distanceValueBuffer, DISTANCEVALUE_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_9361).getText());
    distanceValue.setWildcard(distanceValueBuffer);
    distanceValue.setTypedText(touchgfx::TypedText(T_TMP_SEMIBOLD_35));
    add(distanceValue);

    distanceText.setPosition(60, 88, 120, 23);
    distanceText.setColor(touchgfx::Color::getColorFromRGB(192, 192, 192));
    distanceText.setLinespacing(0);
    distanceText.setWildcard(touchgfx::TypedText(T_TEXT_LAP_DISTANCE).getText());
    ...
    Unicode::snprintf(speedValueBuffer, SPEEDVALUE_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_Y45I).getText());
    speedValue.setWildcard(speedValueBuffer);
    speedValue.setTypedText(touchgfx::TypedText(T_TMP_SEMIBOLD_40));
    add(speedValue);

    speedText.setPosition(70, 13, 100, 23);
    speedText.setColor(touchgfx::Color::getColorFromRGB(192, 192, 192));
    speedText.setLinespacing(0);
    speedText.setWildcard(touchgfx::TypedText(T_TEXT_LAP_SPEED).getText());
