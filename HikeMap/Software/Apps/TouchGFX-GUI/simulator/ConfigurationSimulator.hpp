...
#define GSP_SIM_SPEED_MIN            5 // km/h
#define GPS_SIM_SPEED_BASE           10 // km/h
#define GPS_SIM_SPEED_MAX            15 // km/h
#define GPS_SIM_TIME_SEACH_SATELLITE 4 // seconds

//HeatRate Sensor
#define HEAT_RATE_SIM_ENABLE        1 // 0 - Disable
#define HEAT_RATE_SIM_MIN_HR        80 // Max - 255
#define HEAT_RATE_SIM_MAX_HR        120 // Max - 255
