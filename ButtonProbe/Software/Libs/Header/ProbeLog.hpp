 ...
 ******************************************************************************
 *
 * A copy of RunGuiProbe's, unchanged. Copied rather than shared because these
 * are two independently deployable apps with no library between them, and a
 * probe that a future refactor could quietly change is a probe whose old output
 * files stop meaning what they said. If a third app wants it, that is the point
 * at which it earns a home of its own.
 *
