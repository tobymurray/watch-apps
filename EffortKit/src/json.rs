...
impl<'a> Writer<'a> {
    /// A writer over a caller's buffer, positioned at its start.
    ...
    /// True once anything has been refused for want of room.
    ...
    /// Append text exactly as given, escaping nothing.
    ...
    /// Append one byte, or set the overflow flag.
