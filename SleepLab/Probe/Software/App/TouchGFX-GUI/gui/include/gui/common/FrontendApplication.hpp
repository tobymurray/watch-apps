...
public:
    ...
    virtual void handleTickEvent()
    {
        ...
        // The message pump lives on the simulator's own GUI comm thread
        // (App::Core::runGuiComm), as in every example app. Draining the queue
        // here as well would give one queue two consumers.
#endif
